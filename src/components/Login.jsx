        ...
        >
          <div style={styles.field}>
            ...
            {touched.userId && !userIdIsValid && (
              <div style={styles.error}>
                User ID must match STU-NN (e.g. STU-09).
              </div>
            )}
          </div>
          ...
          <button
            ...
            style={{
              ...
              cursor:
                !userIdIsValid || !passwordIsValid ? "not-allowed" : "pointer",
            }}
          >
            Sign in
          </button>
...
const styles = {
  ...
  input: {
    ...
    width: "100%",
    boxShadow:
      "inset 0 1px 3px rgba(66,123,255,0.04), 0 6px 18px rgba(66,123,255,0.04)",
